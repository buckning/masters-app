...
public class DrawSurfaceScene extends AbstractScene {
	...
	private PaintActivity logger;
	public DrawSurfaceScene(MTApplication mtApplication, String name, PaintActivity log) {
						...
						registerPreDrawAction(new IPreDrawAction() {
							public void processAction() {
								...
								if(lastDrawnPoint != null){
									logger.interactionOccured();
									int lx = (int)lastDrawnPoint.x;
									int ly = (int)lastDrawnPoint.y;
									int x = (int)pos.x;
									int y = (int)pos.y;
									
									if(lx != x && ly != y){
										logger.logInteraction(x, y, "d");	
									}
